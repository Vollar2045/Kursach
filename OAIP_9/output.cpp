...
void output_menu(int m) {
    ...
    default: {
        ...
        cout << endl << "10)Фильтр по выбранному полю";
        cout << endl << "11)Поиск по выбранному полю";      
        cout << endl << "12)Доп. обработка(одинаковый диагноз по убыванию даты посл.визита)";
        cout << endl << "13)Выйти из программы" << endl;
    } break;
    }
}
...
void error_choice() {
    cout << endl << "Выберите вариант от 1 до 13.";
}
